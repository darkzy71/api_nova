...
const resultadolk = (await instagramGetUrl(link)).url_list[0]
var resultado = {
      link: resultadolk
    }
 return(resultado)
...
module.exports = { igdl, geturl, pensador, styletext, getgrupos, gpwhatsapp, hentaistube, nerding, apkmodhacker, xvideos, uptodown, pornhub, soundl, st, gpsrc, dafontSearch, dafontDown, igstalk, ff, papeldeparede, htdl, xvideoss, xvideosdl, assistithtdl, assistitht, pornogratis, wallmob, pinterest, rastrear, ytdl }
